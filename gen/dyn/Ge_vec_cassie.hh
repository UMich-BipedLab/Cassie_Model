...
namespace SymFunction
{
  ...
  inline void Ge_vec_cassie(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var1,const Eigen::VectorXd &var2)
  {
    // Check
    // - Inputs
    ...
    Ge_vec_cassie_raw(p_output1.data(), var1.data(),var2.data());
    }
