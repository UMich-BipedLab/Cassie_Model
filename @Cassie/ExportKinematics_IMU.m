...
export_function(jacobian(H_I1B(1:3,end), encoders), 'J_VectorNav_to_Pelvis', export_path, encoders);
...
export_function(jacobian(H_I1C(1:3,end), encoders), 'J_VectorNav_to_MultisenseLeftOpticalFrame', export_path, encoders);
...
export_function(jacobian(H_I2B(1:3,end), encoders), 'J_Multisense_to_Pelvis', export_path, encoders);
...
export_function(jacobian(H_I2R(1:3,end), encoders), 'J_MultisenseIMU_to_RightToeBottom', export_path, encoders);
...
export_function(jacobian(H_I2L(1:3,end), encoders), 'J_MultisenseIMU_to_LeftToeBottom', export_path, encoders);

export_function(H_I2C, 'R_MultisenseIMU_to_MultisenseLeftOpticalFrame', export_path, encoders);
...
export_function(jacobian(H_I2C(1:3,end), encoders), 'J_MultisenseIMU_to_MultisenseLeftOpticalFrame', export_path, encoders);
